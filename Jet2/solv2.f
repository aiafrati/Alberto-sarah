...
c     +++++++++++++++++++++++++++++++++++++++++++++++++++++
      ...
      subroutine solv2(frint,ng,npc,npsl,yce,zce,yv,zv,ysl,zsl,
...
c        aa(iii,iij+mn)    = aa(iii,iij+mn)    + rli*hpi1/sqh 
c        aa(iii,iij-1+mn)  = aa(iii,iij-1+mn)  - rli1*hpi1/sqh 
c        aa(iii,iij+2*mn)  = aa(iii,iij+2*mn)  - rli/sqh 
c        aa(iii,iij-1+2*mn)= aa(iii,iij-1+2*mn)+ rli1/sqh 
c        aa(iii,iij+3*mn)  = aa(iii,iij+3*mn)  +
c     #                         rli/sqh*( hpi1*(xij-xisi)+(zej-zesi) ) 
c        aa(iii,iij-1+3*mn)= aa(iii,iij-1+3*mn)- 
c     #                         rli1/sqh*( hpi1*(xij-xisi1)+(zej-zesi1) )
c        aa(iii,iij+4*mn)  = aa(iii,iij+4*mn)  +
c     #                          rli/sqh*( hpi1*(zej-zesi)-(xij-xisi) ) 
c        aa(iii,iij-1+4*mn)= aa(iii,iij-1+4*mn)- 
c     #                         rli1/sqh*( hpi1*(zej-zesi1)-(xij-xisi1) )
...
c        aa(iii+2*k1,iij+2*mn)  = aa(iii+2*k1,iij+2*mn)  +  1.d0
c        aa(iii+2*k1,iij+3*mn)  = aa(iii+2*k1,iij+3*mn)  - (zei1-zesi)
c        aa(iii+2*k1,iij+4*mn)  = aa(iii+2*k1,iij+4*mn)  + (xii1-xisi)
* - vn sul corpo (i)
...
c        aa(iii+3*k1,iij+2*mn)  = aa(iii+3*k1,iij+2*mn)  +  1.d0
c        aa(iii+3*k1,iij+3*mn)  = aa(iii+3*k1,iij+3*mn)  - (zei-zesi)
c        aa(iii+3*k1,iij+4*mn)  = aa(iii+3*k1,iij+4*mn)  + (xii-xisi)
* - phi sulla SL (j1)
